 ...
 */
final class Version20200625163057 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payement DROP card_id, DROP card_pass');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payement ADD card_id INT DEFAULT NULL, ADD card_pass INT DEFAULT NULL');

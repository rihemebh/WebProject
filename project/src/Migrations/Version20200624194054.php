 ...
 */
final class Version20200624194054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payement ADD books LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE card_id card_id INT DEFAULT NULL, CHANGE card_pass card_pass INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payement DROP books, CHANGE card_id card_id INT DEFAULT NULL, CHANGE card_pass card_pass INT DEFAULT NULL');

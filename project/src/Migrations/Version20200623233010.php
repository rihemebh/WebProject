 ...
 */
final class Version20200623233010 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD image VARCHAR(255) DEFAULT NULL, ADD description VARCHAR(255) DEFAULT NULL');
